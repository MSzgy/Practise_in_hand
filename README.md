...
- [speech/README.md](./speech/README.md): 语音模型 TTS 学习教程，用 `microsoft/speecht5_tts` 拆解小模型合成链路，用 `openbmb/VoxCPM2` 体验 2B 参数、多语言、48kHz、音色设计和克隆能力，并新增可运行的 Qwen3-TTS ModelScope 测试 notebook，覆盖 speech token、dual-track LM、MTP、合成 WAV 和 RTF。
